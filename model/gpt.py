...
class GPTLanguageModel(nn.Module):
    ...
    def __init__(self, vocab_size, n_embd, block_size, n_head, n_layer, device, dropout):
        ...
        # self.sa_head = Head(n_emb_dim)  # sa_head ---> self-attention head
        # self.sa_heads = MultiHeadAttention(n_emb_dim//4, 4)  # 4 heads of 8-dimensional self-attention
    ...
    def forward(self, idx, targets=None):
        ...
        # idx and targets are both (B,T) tensor of integers. idx ---> inputs
